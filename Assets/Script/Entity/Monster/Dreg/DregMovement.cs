...
public class DregMovement : MonoBehaviour, I_Attackable
{
    [Header("움직임")]
    ...
    [Header("방패")]
    public float paralysisTime = 0.5f;
    ...
    private bool isParalyzed = false;   // 공격으로 인해 마비되었는지 여부
    ...
    public bool CanAttack(Transform attackerPos)
    {
        ...
        bool blockingLeft = !isFacingRight && (myX > shieldX);
    ...
    IEnumerator ParalyzedCoroutine(float duration)
    {
        isParalyzed = true;
